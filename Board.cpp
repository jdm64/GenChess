...
Board::Board()
{
	pieces = {
		...
		{BLACK_PAWN, PLACEABLE},	{BLACK_PAWN, PLACEABLE},
		{BLACK_PAWN, PLACEABLE},	{BLACK_PAWN, PLACEABLE},
		{BLACK_KNIGHT, PLACEABLE},	{BLACK_KNIGHT, PLACEABLE},
		{BLACK_BISHOP, PLACEABLE},	{BLACK_BISHOP, PLACEABLE},
		{BLACK_ROOK, PLACEABLE},	{BLACK_ROOK, PLACEABLE},
		{BLACK_QUEEN, PLACEABLE},	{BLACK_KING, PLACEABLE},

		{WHITE_PAWN, PLACEABLE},	{WHITE_PAWN, PLACEABLE},
		{WHITE_PAWN, PLACEABLE},	{WHITE_PAWN, PLACEABLE},
		{WHITE_PAWN, PLACEABLE},	{WHITE_PAWN, PLACEABLE},
		{WHITE_PAWN, PLACEABLE},	{WHITE_PAWN, PLACEABLE},
		{WHITE_KNIGHT, PLACEABLE},	{WHITE_KNIGHT, PLACEABLE},
		{WHITE_BISHOP, PLACEABLE},	{WHITE_BISHOP, PLACEABLE},
